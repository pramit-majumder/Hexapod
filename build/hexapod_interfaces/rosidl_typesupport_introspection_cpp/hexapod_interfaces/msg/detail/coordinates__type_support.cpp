...
{
  new (message_memory) hexapod_interfaces::msg::Coordinates(_init);
}

void Coordinates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hexapod_interfaces::msg::Coordinates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Coordinates_message_member_array[3] = {
  {
    ...
    offsetof(hexapod_interfaces::msg::Coordinates, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hexapod_interfaces::msg::Coordinates, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hexapod_interfaces::msg::Coordinates, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coordinates_message_members = {
  ...
  3,  // number of fields
  sizeof(hexapod_interfaces::msg::Coordinates),
...
{
  return &::hexapod_interfaces::msg::rosidl_typesupport_introspection_cpp::Coordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hexapod_interfaces, msg, Coordinates)() {
  return &::hexapod_interfaces::msg::rosidl_typesupport_introspection_cpp::Coordinates_message_type_support_handle;
}
