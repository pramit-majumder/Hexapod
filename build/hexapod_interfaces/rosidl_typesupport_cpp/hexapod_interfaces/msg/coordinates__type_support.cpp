...
static const _Coordinates_type_support_symbol_names_t _Coordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hexapod_interfaces, msg, Coordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hexapod_interfaces, msg, Coordinates)),
  }
};
...
{
  return &::hexapod_interfaces::msg::rosidl_typesupport_cpp::Coordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hexapod_interfaces, msg, Coordinates)() {
  return get_message_type_support_handle<hexapod_interfaces::msg::Coordinates>();
}
