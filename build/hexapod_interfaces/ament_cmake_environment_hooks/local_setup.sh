...
: ${AMENT_CURRENT_PREFIX:="/home/waves/hexapod/install/hexapod_interfaces"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hexapod_interfaces/environment/library_path.sh"
