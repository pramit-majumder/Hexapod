...
#include "hexapod_interfaces/msg/detail/coordinates__rosidl_typesupport_fastrtps_c.h"
...
using _Coordinates__ros_msg_type = hexapod_interfaces__msg__Coordinates;
...
size_t get_serialized_size_hexapod_interfaces__msg__Coordinates(
  const void * untyped_ros_message,
...
static uint32_t _Coordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_interfaces__msg__Coordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hexapod_interfaces
size_t max_serialized_size_hexapod_interfaces__msg__Coordinates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_interfaces__msg__Coordinates;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Coordinates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_interfaces__msg__Coordinates(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_interfaces, msg, Coordinates)() {
