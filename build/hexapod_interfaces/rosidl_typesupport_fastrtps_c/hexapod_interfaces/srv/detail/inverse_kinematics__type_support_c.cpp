...
#include "hexapod_interfaces/srv/detail/inverse_kinematics__rosidl_typesupport_fastrtps_c.h"
...
using _InverseKinematics_Request__ros_msg_type = hexapod_interfaces__srv__InverseKinematics_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: coxa_length
  {
    cdr << ros_message->coxa_length;
  }

  // Field name: femur_length
  {
    cdr << ros_message->femur_length;
  }

  // Field name: tibia_length
  {
...
size_t get_serialized_size_hexapod_interfaces__srv__InverseKinematics_Request(
  const void * untyped_ros_message,
...
static uint32_t _InverseKinematics_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_interfaces__srv__InverseKinematics_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hexapod_interfaces
size_t max_serialized_size_hexapod_interfaces__srv__InverseKinematics_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_interfaces__srv__InverseKinematics_Request;
    is_plain =
      (
...
static size_t _InverseKinematics_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_interfaces__srv__InverseKinematics_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_interfaces, srv, InverseKinematics_Request)() {
...
using _InverseKinematics_Response__ros_msg_type = hexapod_interfaces__srv__InverseKinematics_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hexapod_interfaces
size_t get_serialized_size_hexapod_interfaces__srv__InverseKinematics_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InverseKinematics_Response__ros_msg_type * ros_message = static_cast<const _InverseKinematics_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_interfaces__srv__InverseKinematics_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hexapod_interfaces
size_t max_serialized_size_hexapod_interfaces__srv__InverseKinematics_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hexapod_interfaces__srv__InverseKinematics_Response;
    is_plain =
      (
...
static size_t _InverseKinematics_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_interfaces__srv__InverseKinematics_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_interfaces, srv, InverseKinematics_Response)() {
...
// already included above
// #include "hexapod_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "hexapod_interfaces/srv/inverse_kinematics.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_interfaces, srv, InverseKinematics)() {
